...
<head>    
    ...
    <link rel="stylesheet" href="CSS/formattedCSS.css" type="text/css"/>
...
<body class="w3-light-grey">
    ...
    <div class="w3-bar w3-top w3-khaki w3-large" style="z-index:4">
      ...
      <span class="w3-bar-block w3-center w3-top" id="titleH1"><h1>Welcome to Team Cash Flow Services</h1></span>
      <span class="w3-bar-item w3-right"><img src="Images/logoTransparent.png" width="82" height="50"/></span>
    </div>
